...
//地理位置,本地天气
          if($form_MsgType=="location")
          {
            ...
            //抓取百度地址解析
              ...
              $x="http://1.hauyu.applinzi.com/car_tip.php?x=".$from_Location_X."&y=".$from_Location_Y;
  	...
  	//文字消息
	      ...
	      //如果发送内容则根据关键字恢复相应信息
            ...
            if($form_Content=='车位' || $form_Content=='5' )
              ...
              <PicUrl><![CDATA[http://dreamwhat-img.stor.sinaapp.com/u=3116266380,2489126012&fm=21&gp=0.jpg]]></PicUrl>\n
              <Url><![CDATA[http://1.hauyu.applinzi.com/position.php?x=$kk&y=$fromUsername]]></Url>\n
              </item>\n
              </Articles>\n
              <FuncFlag>0</FuncFlag>\n
              </xml>";   
			 ...
			 if($form_Content=='admin' ||  $form_Content=='xxx' || $form_Content=='7' || $form_Content=='管理')
			{
              ...
              <Url><![CDATA[http://1.hauyu.applinzi.com/admin.php]]></Url>\n
              </item>\n
              ...
              <Url><![CDATA[http://1.hauyu.applinzi.com/car_user.php?x=$fromUsername]]></Url>\n
              </item>\n
              </Articles>\n
              <FuncFlag>0</FuncFlag>\n
              </xml>";
            ...
            if($form_Content=='解除' || $form_Content=='6')
              ...
              <Description><![CDATA[快戳我，戳！戳！戳！]]></Description>\n
              <PicUrl><![CDATA[http://dreamwhat-img.stor.sinaapp.com/u=3116266380,2489126012&fm=21&gp=0.jpg]]></PicUrl>\n
              <Url><![CDATA[http://1.hauyu.applinzi.com/update.info.php?$fromUsername]]></Url>\n
              </item>\n
